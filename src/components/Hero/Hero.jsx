  ...
  return (
    <div className={`w-full lg:h-dvh   ${styles.hero}`}>
      ...
      <div className="flex-col text-center items-center justify-center font-taj  lg:mt-0 space-y-16  ">
        ...
        <div>
          {" "}
          <h1 className=" text-2xl lg:text-[26px] text-[#F4F9FA] font-bold mb-3  ">
            {t("h1")}
          </h1>
          <p className="text-2xl lg:text-[20px] text-[#F4F9FA] leading-[40px]  mb-10 lg:mb-[30px] md:mt-5 lg:mt-3 pe-3 ">
            {t("HeroCont")}
          </p>
        </div>
        ...
        <div className="flex-col  justify-center items-center">
          ...
          <a
          href="https://www.youtube.com/@sindiontechnologyltd3700"
          target="_blank"
          className="flex items-center justify-center mt-[20px] font-bold text-white"
        >
          <span className="me-2 w-3 h-3 p-[10px]  flex justify-center items-center ">
