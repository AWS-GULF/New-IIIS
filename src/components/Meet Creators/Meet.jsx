...
export default function Meet({ isRTL ,i18n }) {
  ...
  return (
    ...
    <div className={`lg:flex lg:flex-row flex-col space-y-10 text-center px-2 lg:justify-between lg:items-center lg:py-10 font-taj
      ${ i18n==='en'? meetstyle.bg:meetstyle.bgr}`} id="creators">
