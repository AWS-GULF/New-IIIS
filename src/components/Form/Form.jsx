...
const ContactForm = () => {
  ...
  return (
    <div className="relative lg:top-[-200px] w-full min-h-screen flex flex-col items-center justify-center pb-[100px] bg-white px-4 md:px-0 overflow-hidden" id="form">

      <div className={`${styles.bg} hidden lg:block absolute top-0 left-[-150px] w-1/3 h-full bg-cover bg-no-repeat`}></div>
      <div className={`${styles.secbg} hidden lg:block absolute top-0 right-[-150px] w-1/3 h-full bg-cover bg-no-repeat`}></div>
